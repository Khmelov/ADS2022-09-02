...
public class Lesson2Test {
    ...
    */
    ...
    public void B_Sheduler_f(){
        ...
        List<B_Sheduler.Event> starts = instance.calcStartTimes(events, 2, 10);  //рассчитаем оптимальное заполнение аудитории
        boolean ok=starts.toString().equals("[(2:3), (3:5), (6:7), (7:9)]");
        assertTrue("B_Sheduler failed", ok);
    }
    @Test

...
public class Lesson5Test {
    ...
    public void A_1() throws Exception {
        ...
        A_QSort instance = new A_QSort();
        int[] result=instance.getAccessory(stream);
        boolean ok=Arrays.equals(result,new int[]{2, 3, 4, 4, 4, 5, 4 , 3, 3, 3, 3 });
        assertTrue("A failed", ok);
    }
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group151002/rusakovich/lesson05/dataC.txt");

...
public class Lesson3Test {
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group151002/krashevskiy/lesson03/dataHuffman.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        File f = new File(root + "by/it/group151002/krashevskiy/lesson03/encodeHuffman.txt");

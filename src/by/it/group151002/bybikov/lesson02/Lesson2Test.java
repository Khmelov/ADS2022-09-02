...
public class Lesson2Test {
    ...
    */
    ...
    public void A_VideoRegistrator() {
        ...
        events = new double[]{1, 1.1, 1.6, 2.0, 2.1, 2.7, 3.2, 8.1, 9.2, 5.5, 3.7};
        starts=instance.calcStartTimes(events,1);
        ok = starts.toString().equals("[1.0, 2.1, 3.2, 5.5, 8.1, 9.2]");
        assertTrue("slowA failed", ok);
        ...
        events = new double[]{1.1, 1.6, 2.0, 2.1, 2.7, 4.5, 8.0, 9.2, 5.5, 3.7};
        starts=instance.calcStartTimes(events,1);
        ok = starts.toString().equals("[1.1, 2.7, 4.5, 8.0, 9.2]");
        assertTrue("slowA failed", ok);
    }
    ...
    public void B_Sheduler() {
        ...
        events = new B_Sheduler.Event[]{new B_Sheduler.Event(0, 3), new B_Sheduler.Event(0, 1), new B_Sheduler.Event(1, 2), new B_Sheduler.Event(3, 4),
                new B_Sheduler.Event(4, 9), new B_Sheduler.Event(4, 10), new B_Sheduler.Event(9, 10), new B_Sheduler.Event(10, 10)
        };

        starts = instance.calcStartTimes(events, 0, 10);  //рассчитаем оптимальное заполнение аудитории
        ok=starts.toString().equals("[(0:1), (1:2), (3:4), (4:9), (9:10), (10:10)]");
        assertTrue("B_Sheduler failed", ok);
    ...
    public void C_GreedyKnapsack() throws Exception {
        ...
        f=new File(root+"by/it/group151002/bybikov/lesson02/greedyKnapsack.txt");

...
public class Lesson3Test {
    ...
    */
    ...
    public void B() throws Exception {
        ...
        f = new File(root + "by/it/group151002/bybikov/lesson03/encodeHuffman_Test_1.txt");
        result = instance.decode(f);
        ok=result.equals("KRASNARAKRASKAK");
        assertTrue("B failed", ok);
    ...
    public void C() throws Exception {
        ...
        stream = new FileInputStream(root + "by/it/group151002/bybikov/lesson03/heapData_Test_1.txt");

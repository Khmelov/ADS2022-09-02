...
public class Test_jd01_11 extends HomeWork {
    ...
    @Test(timeout = 1500)
    public void testTaskA__TaskA() throws Exception {
    ...
    @Test(timeout = 1500)
    public void testTaskB__TaskB() throws Exception {
        System.out.println("\nB. Диагностика обязательных к реализации методов:");
        Class<?> aclass = findClass("TaskB");
    ...
    @Test(timeout = 1500)
    public void testTaskC__TaskC() throws Exception {
        System.out.println("\nC. Диагностика обязательных к реализации методов:");
        Class<?> aclass = findClass("TaskC");

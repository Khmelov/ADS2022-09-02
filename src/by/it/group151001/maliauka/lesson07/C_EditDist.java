package by.it.group151001.maliauka.lesson07;
...
Необходимо:
    ...
    Итерацион но вычислить алгоритм преобразования двух данных непустых строк
...
public class C_EditDist {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group151001/aleksandrov/lesson07/dataABC.txt");

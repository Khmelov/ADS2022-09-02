package by.it.group151001.pastukhou.lesson09;
...
public class ListB<E> implements List<E> {
    ...
    public void add(int index, E element) {
        if (cntElements == sizeElements) {
            realloc();
        }
        int len = cntElements - index;
        System.arraycopy(objects, index, objects, index + 1, len);
        objects[index] = element;
        cntElements++;
    }

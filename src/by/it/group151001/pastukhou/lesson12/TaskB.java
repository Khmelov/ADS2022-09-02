...
public class TaskB {
    ...
    public static void main(String[] args) {
        ...
        taskB.edges.add(new Node(0,2, -2));
        taskB.edges.add(new Node(0,1, 4));
        taskB.edges.add(new Node(1,6, -2));
        taskB.edges.add(new Node(1,7, -4));
        taskB.edges.add(new Node(2,3, 2));
        taskB.edges.add(new Node(2,5, 1));
        taskB.edges.add(new Node(4,5, -2));
        taskB.edges.add(new Node(4,7, 3));
        taskB.edges.add(new Node(5,3, 3));
        taskB.edges.add(new Node(6,8, -1));
        taskB.edges.add(new Node(7,6, 1));
        taskB.edges.add(new Node(8,7, 1));
        taskB.edges.add(new Node(9,0, 7));
        taskB.edges.add(new Node(9,2, 6));
        taskB.edges.add(new Node(9,5, 5));
        taskB.edges.add(new Node(9,4, 6));

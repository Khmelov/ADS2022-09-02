...
public class TaskC {
    ...
    public static void main(String[] args) {
        ...
        TaskC tplgSort = new TaskC(graph);
        tplgSort.sort();
        tplgSort.findSourcesAndSinks();
        int lins = tplgSort.srcs * 2 * 2;
        System.out.println("Linearizations: " + lins);
        System.out.println("Pre values: " + tplgSort.getPreValues());
        System.out.println("Post values: " + tplgSort.getPostValues());
        System.out.println("Topological order: " + tplgSort.getTopologicalOrder());
    }
}

...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        while (priorityQueue != null && priorityQueue.size() >1)
        {
            Node FirstNode  = priorityQueue.poll();
            Node SecondNode = priorityQueue.poll();
            InternalNode node = new InternalNode(FirstNode,SecondNode);
            priorityQueue.add(node);
        }
        ...
        Node HuffmanCode = priorityQueue.poll();
        HuffmanCode.fillCodes("");

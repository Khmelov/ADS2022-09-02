...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for(Map.Entry<Character, Integer> Iter: count.entrySet())
         priorityQueue.add(new LeafNode(Iter.getValue(),Iter.getKey()));

        InternalNode temp;

        while(priorityQueue.size()>1)
        {
        temp = new InternalNode(priorityQueue.remove(),priorityQueue.remove());
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/group151001/timoshek/lesson03/dataHuffman.txt");

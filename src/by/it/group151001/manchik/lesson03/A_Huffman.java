package by.it.group151001.manchik.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character,Integer> MapEntry : count.entrySet()){
            priorityQueue.add(new LeafNode(MapEntry.getValue(), MapEntry.getKey()));
        }

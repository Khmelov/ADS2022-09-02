package by.it.group151001.manchik.lesson12;
...
public class Lesson12Test {
    ...
    public void taskA() {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            System.out.println("The shortest path from " + A.START_VERTEX + " to " + (char)(A.START_VERTEX + i) + " = " + A.dist[i]);
        }
    }
    @Test(timeout = 2000)
    public void taskB() {
    ...
    public void taskC() {
        ...
        System.out.print("The smallest length of the cycle between " + (char)(TaskC.u + 'A') + " and " + (char)(TaskC.v + 'A') + " = " + TaskC.findTheSmallestCycle());

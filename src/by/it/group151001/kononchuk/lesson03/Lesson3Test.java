package by.it.group151001.kononchuk.lesson03;
...
public class Lesson3Test {
    ...
    */
    ...
    public void A() throws Exception {
        ...
        File f = new File(root + "by/it/group151001/kononchuk/lesson03/dataHuffman.txt");
    ...
    public void C() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group151001/kononchuk/lesson03/heapData.txt");

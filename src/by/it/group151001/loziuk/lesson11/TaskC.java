...
public class TaskC {public Map<Character, List<Character>> graph;
    ...
    public void findSourcesAndSinks() {
        ...
        List<Character> finish = new ArrayList<>();
        for (char vertex : graph.keySet()) {
        ...
        this.src = start.size();
        System.out.println("Sources: " + start);
        System.out.println("Sinks: " + finish);
    }
    ...
    public static void main(String[] args) {
        ...
        int lins = topologicalSort.src * 2 * 2;

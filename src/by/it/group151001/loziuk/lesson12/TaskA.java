package by.it.group151001.loziuk.lesson12;
...
public class TaskA {
    ...
    public static void dijkstra(int start) {
        ...
        PriorityQueue<Node> PrQ = new PriorityQueue<>(new Comparator<Node>() {
            @Override
        ...
        while (!PrQ.isEmpty()) {
            ...
            for (int i = 0; i < adj.get(here).size(); i++) {
                ...
                if (dist[there] > dist[here] + cost) {
                    ...
                    PrQ.offer(new Node(there, dist[there]));
                }
            }
        }
    }

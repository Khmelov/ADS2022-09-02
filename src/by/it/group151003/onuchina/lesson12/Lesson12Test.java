package by.it.group151003.onuchina.lesson12;
...
public class Lesson12Test {
    ...
    public void TaskA() throws Exception {
        ...
        gr.dijkstra(0);
        assertTrue("Failed", (gr.dist[0] == 0));
        assertTrue("Failed", (gr.dist[1] == 1));
        assertTrue("Failed", (gr.dist[2] == 3));
        assertTrue("Failed", (gr.dist[3] == 4));
        assertTrue("Failed", (gr.dist[4] == 4));
        assertTrue("Failed", (gr.dist[5] == 7));
        assertTrue("Failed", (gr.dist[6] == 5));
        assertTrue("Failed", (gr.dist[7] == 6));
    }
    @Test(timeout = 2000)
    public void TaskB() throws Exception {
        ...
        gr.fordBellman(0);
        assertTrue("Failed", (gr.dist[0] == 0));
        assertTrue("Failed", (gr.dist[1] == 4));
        assertTrue("Failed", (gr.dist[2] == -2));
        assertTrue("Failed", (gr.dist[3] == 0));
        assertTrue("Failed", (gr.dist[5] == -1));
        assertTrue("Failed", (gr.dist[6] == 1));
        assertTrue("Failed", (gr.dist[7] == 0));
        assertTrue("Failed", (gr.dist[8] == 0));
    }

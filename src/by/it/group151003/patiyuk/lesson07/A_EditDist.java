...
public class A_EditDist {
    ...
    int getDistanceEdinting(String one, String two) {
        ...
        int substitution = getDistanceEdinting(one.substring(1), two.substring(1)) + costOfSubstitution(one.charAt(0), two.charAt(0));
    ...
    private int min(int substitution, int insertion, int deletion) {

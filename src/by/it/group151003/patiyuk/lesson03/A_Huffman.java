package by.it.group151003.patiyuk.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        //5. вызовем метод заполнения кодов для корня дерева
        root.fillCodes("");

        //6. переберем все символы в строке и запишем их коды в StringBuilder sb
        for (int i = 0; i < s.length(); i++) {
            sb.append(codes.get(s.charAt(i)));
        }

        //7. вернем строку с кодами символов
        return sb.toString();
        //01001100100111
        //01001100100111
    }

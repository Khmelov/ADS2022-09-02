...
public class Lesson5Test {
    ...
    public void A() throws Exception {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group151003/polovoy/lesson05/dataA.txt");
        A_QSort instance = new A_QSort();
        int[] result=instance.getAccessory(stream);
        boolean ok=Arrays.equals(result,new int[]{2,0,1});
    ...
    public void B() throws Exception {
        ...
        boolean ok=Arrays.equals(result,new int[]{1, 2, 2, 3, 4, 5, 6, 8, 9, 9, 10, 10, 10});

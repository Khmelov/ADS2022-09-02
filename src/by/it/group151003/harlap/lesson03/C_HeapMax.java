package by.it.group151003.harlap.lesson03;
...
public class C_HeapMax {
    ...
    private class MaxHeap {
        ...
        //двоичная куча значения в любой вершине не меньше чем любой потомок
        ...
        int siftDown(int i) {//просеивание вниз
            ...
            while (2*i+1< heap.size()) {
                int leftn = (2 * i + 1), rightn = (2 * i) + 2, k = leftn;
                if (rightn < heap.size() && heap.get(rightn) > heap.get(leftn))
                    k = rightn;

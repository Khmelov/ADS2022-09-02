package by.it.group151003.saydalikhujaev.lesson11;
...
public class TaskC {
    ...
    public static List<Character> lineariz = new ArrayList<>();
    ...
    public static void dfs(Graph graph, int vertex) {
        ...
        for (int i : graph.getNeighbors(vertex))
            if (!visited[i])
                dfs(graph, i);
        lineariz.add(graph.getName(vertex));
        post[vertex] = clock++;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("One of linearizations of graph: " + lineariz);

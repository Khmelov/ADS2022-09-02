package by.it.group151003.yagnish.lesson10;

import java.util.*;

public class Task<E>  implements NavigableSet<E> {
    ...
    public Task(Comparator<? super E> comparator) {
    ...
    public Task(E[] keys, Comparator<? super E> comparator) {
        this.comparator = comparator;
        for (E key : keys)
            add(key);
    }

    public Task(Iterable<? extends E> keys) {
        for (E key : keys)
            add(key);
    }

    public Task(Iterable<? extends E> keys, Comparator<? super E> comparator) {
        this.comparator = comparator;
        for (E key : keys)
            add(key);
    }

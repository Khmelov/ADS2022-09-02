package by.it.group151003.pavluchenko.lesson11;
...
public class TaskC {
    ...
    public static void search(Graph1 graph, int vertex) {
        visited[vertex] = true;
    ...
    public static List<Character> sourceAndStocks(Graph1 graph) {
    ...
    public static void DFS (Graph1 graph, int start) {

...
public class Lesson4Test {
    ...
    public void A() throws Exception {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group151003/stoyanov/lesson04/dataA.txt");
        ...
        boolean ok=sb.toString().trim().equals("3 1 -1 1 -1 -1 8 9");

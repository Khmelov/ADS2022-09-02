...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for(Map.Entry<Character, Integer> item : count.entrySet()){
            LeafNode leafNode = new LeafNode(item.getValue(), item.getKey());
        ...
        while (priorityQueue.size() != 1) {
            InternalNode parent = new InternalNode(priorityQueue.poll(), priorityQueue.poll());
        ...
        //.....
        InternalNode rootNode = (InternalNode) priorityQueue.poll();

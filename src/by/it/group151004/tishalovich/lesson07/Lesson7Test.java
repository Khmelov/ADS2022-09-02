...
public class Lesson7Test {
    ...
    public void A() throws Exception {
        ...
        assertEquals("A3 failed", instance.getDistanceEdinting("python","java"),6);
        assertEquals("A3 failed", instance.getDistanceEdinting("polynomial","exponential"),6);
        assertEquals("A3 failed", instance.getDistanceEdinting("africa","america"),2);
    }
    ...
    public void B() throws Exception {
        ...
        assertEquals("B1 failed", instance.getDistanceEdinting("python","java"),6);
        assertEquals("B2 failed", instance.getDistanceEdinting("polynomial","exponential"),6);
        assertEquals("B3 failed", instance.getDistanceEdinting("africa","america"),2);
    }
    ...
    public void C() throws Exception {
        ...
        assertEquals("C4 failed", instance.getDistanceEdinting("vasya","katya").split("#").length,4);
        assertEquals("C5 failed", instance.getDistanceEdinting("english","meaning").split("#").length,4);
    }

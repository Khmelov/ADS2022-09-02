...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for(int i=0; i<s.length();i++){
            ...
            if(!(count.containsKey(symb))){
                ...
                int a = count.get(symb);
                count.replace(symb, a+1);
            }
        }
        ...
        for(Map.Entry<Character, Integer> item: count.entrySet()){
            LeafNode leaf = new LeafNode(item.getValue(),item.getKey());
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        File f = new File(root + "by/it/group151004/buhovets/lesson03/dataHuffman.txt");

...
import by.it.group151004.golovchuk.lesson12.TaskA;
import by.it.group151004.golovchuk.lesson12.TaskA.Pair;
import by.it.group151004.golovchuk.lesson12.TaskB;
import by.it.group151004.golovchuk.lesson12.TaskC;
...
public class Lesson12Test {
	...
	public void taskA() throws Exception {
		by.it.group151004.golovchuk.lesson12.TaskA sus = new TaskA();
		for (int i = 0; i < 8; i++) {
	...
	public void taskB() throws Exception {
		by.it.group151004.golovchuk.lesson12.TaskB sus = new TaskB();
		sus.bellmanFord(0);
	...
	public void taskC() throws Exception {
		by.it.group151004.golovchuk.lesson12.TaskC sus = new TaskC(2, 3);

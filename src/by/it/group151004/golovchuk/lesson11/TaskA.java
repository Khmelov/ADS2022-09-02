...
public class TaskA {
    ...
    public static class DFS {
        ...
        public DFS(by.it.group151004.afanasenko.lesson11.TaskA g) {
        ...
        public void dfs(by.it.group151004.afanasenko.lesson11.TaskA g, int v) {
            visited[v] = true;
            pre[v] = preCounter++;
    ...
    public static void main(String[] args) {
        by.it.group151004.afanasenko.lesson11.TaskA g = new by.it.group151004.afanasenko.lesson11.TaskA(9);
        g.setVertexName(0, "A");
        g.setVertexName(1, "B");
        g.setVertexName(2, "C");
        g.setVertexName(3, "D");
        ...
        by.it.group151004.afanasenko.lesson11.TaskA.DFS dfs = new by.it.group151004.afanasenko.lesson11.TaskA.DFS(g);

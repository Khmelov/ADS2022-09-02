package by.it.group151004.sakovsky.lesson02;
...
public class Lesson2Test {
    ...
    */
    ...
    public void A_VideoRegistrator() {
        ...
        double[] events2=new double[]{0.7, 1.5, 0.3, 2.5, 7.9, 8.4, 5.8, 4.6, 9.4, 5.5, 3.7};
        List<Double> starts2=instance.calcStartTimes(events2,1); //рассчитаем моменты старта, с длинной сеанса 1
        boolean ok2=starts2.toString().equals("[0.3, 1.5, 2.5, 3.7, 5.5, 7.9, 9.4]");
        assertTrue("slowA failed", ok2);
    }

...
public class TaskC<E>  implements NavigableSet<E> {
    ...
    public E first() {
        Node<E> node = root;
        while(node!=null && node.left!=null && node.left.data!=null){
            node = node.left;
        }
        return node.data;
    }
    ...
    public E last() {
        Node<E> node = root;
        while(node!=null &&  node.right!= null &&node.right.data!=null){
            node = node.right;
        }
        return node.data;
    }
    ...
    private E findMin(Node<E> node){
        Node<E> result = node;
        while(result.left!=null && result.left.data!=null){
            result = result.left;
        }
        return result.data;
    }
    ...
    public E lower(E e) {
        Node<E> current = root;
        boolean canExit = current==null;
        while(!canExit){
            int compareResult = compareNodes(current.data,e);
            if(compareResult!=-1){
                ...
                if(current.right!=null && current.right.data!=null && compareNodes(findMin(current.right),e)==-1){
    ...
    private E findMax(Node<E> node){
        Node<E> result = node;
        while(result.right!=null && result.right.data!=null){
            result = result.right;
        }
        return result.data;
    }
    ...
    public E ceiling(E e) {
        ...
        while(!canExit){
            int compareResult = compareNodes(current.data,e);
            if(compareResult==1){
                if(current.left==null || current.left.data==null || compareNodes(findMax(current.left),e)==-1){
                    canExit=true;
                } else{
                    current = current.left;
                }

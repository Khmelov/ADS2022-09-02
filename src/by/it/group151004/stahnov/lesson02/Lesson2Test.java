...
public class Lesson2Test {
    ...
    */
    ...
    public void B_Sheduler1() {
        ...
        List<B_Sheduler.Event> starts = instance.calcStartTimes(events, 3, 7);  //рассчитаем оптимальное заполнение аудитории
        boolean ok=starts.toString().equals("[(3:5), (6:7)]");
        assertTrue("B_Sheduler1 failed", ok);
    }

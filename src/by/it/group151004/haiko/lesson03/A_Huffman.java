...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        Character[] myArr = {};
        myArr = count.keySet().toArray(new Character[0]);

        for (int i=0; i< myArr.length; i++) {
            LeafNode nd = new LeafNode(count.get(myArr[i]), myArr[i]);
        ...
        while (priorityQueue.size()>1){
            ...
            InternalNode in = new InternalNode(priorityQueue.poll(), priorityQueue.poll());

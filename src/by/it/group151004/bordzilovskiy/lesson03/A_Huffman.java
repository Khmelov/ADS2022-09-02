package by.it.group151004.bordzilovskiy.lesson03;
...
// постройте оптимальный по суммарной длине безпрефиксный код.
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (HashMap.Entry <Character, Integer> entry : count.entrySet()) {
            // System.out.println("Символ: " + entry.getKey() + "      Количество повторений: " + entry.getValue());
